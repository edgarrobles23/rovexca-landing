...
export default function LeadFormSection() {
  ...
  const onSubmit = async (data: LeadFormData) => {
    ...
    try {
      ...
      if (json.success) {
        setDone(true);
        trackEvent("submit_contact_form", { location: "lead_form", source: "landing_rovexca_health" });
      }
          ...
          <div>
            ...
            <div>
              ...
              <a
                ...
                className="btn-green"
                style={{ fontSize: 14 }}
                onClick={() => trackEvent("click_whatsapp", { location: "lead_form", source: "landing_rovexca_health" })}
              >
