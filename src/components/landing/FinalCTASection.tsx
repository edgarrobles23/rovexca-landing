...
const openTrial = () => {
  trackEvent("click_free_trial", { location: "final_cta", source: "landing_rovexca_health" });
    ...
    <section style={{ background: "linear-gradient(150deg, #0f172a 0%, #1e3a8a 100%)", padding: "88px 0" }}>
      <div className="container" style={{ textAlign: "center" }}>
        ...
        <div style={{ display: "flex", gap: 14, justifyContent: "center", flexWrap: "wrap", marginBottom: 36 }}>
          ...
          <a
            href="#demo"
            onClick={() => trackEvent("click_demo", { location: "final_cta", source: "landing_rovexca_health" })}
            style={{
            display: "inline-flex", alignItems: "center", justifyContent: "center",
          ...
          <a href={`https://wa.me/528110804363?text=${encodeURIComponent("Hola, quiero una demo de Rovexca Health.")}`}
            ...
            onClick={() => trackEvent("click_whatsapp", { location: "final_cta", source: "landing_rovexca_health" })}
          >
